...
<head>
    ...
    <title>Australasian Digital Heritage Database</title>
...
<div class="mainWrapper">
    ...
    //File that contains the social accounts, AHSD logo and menu in mobile mode ?>
        ...
        <div id="innerMainContent">
            <div id="innerMainContentLeftColumn">
                ...
                <div id="indexInnerBodyLeft_1">
                    ...
                    <p>
                        <?php include("text/adhd_welcome.txt"); ?>
                    </p>
                </div>
                <div id="indexInnerBodyLeft_2">
                    <h1 id="headerTitle">Supporting Institutions</h1>
                    <p><?php include("text/sup_supportingInstitutions.txt"); ?> </p>

                    <h3 id="headerTitleH3">Institution Name</h3>
                    <?php include("ADHD_supportingInstitutions.php"); //File that contains the table of supporting institutions ?>
                    </p>
                </div>
            </div>
